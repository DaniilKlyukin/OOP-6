# Объектно-ориентированное программирование 2 (6 семестр)

Учебный репозиторий для студентов 3 курса (6 семестр) направления **«Прикладная математика и информатика»**. Курс посвящен продвинутому проектированию корпоративного ПО, изучению архитектурных паттернов (GoF), созданию современных Desktop (Avalonia UI) и Web (ASP.NET Core) приложений, а также принципам Чистой архитектуры (Clean Architecture).
...
*   **Технологии:** Avalonia UI (Desktop), ASP.NET Core (Web/API), EF Core (ORM).
*   **Инструменты:** Docker, Swagger, Postman, SQLite/PostgreSQL.

---

## 🎓 Аттестация (6 семестр)

*   **Форма контроля:** Экзамен.
*   **Условия допуска:** Сданные лабораторные работы и защищенные практические задания.
*   **Экзаменационные билеты:** [Просмотреть вопросы к экзамену](Билеты.docx).
...
2.  **Эрих Гамма и др.** — «Приемы объектно-ориентированного проектирования. Паттерны проектирования».
3.  **Адам Фримен** — «ASP.NET Core MVC 2 с примерами на C# для профессионалов».
4.  **Джеффри Рихтер** — «CLR via C#. Программирование на платформе .NET Framework».
5.  **Документация Avalonia UI:** [docs.avaloniaui.net](https://docs.avaloniaui.net/)